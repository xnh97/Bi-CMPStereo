...
class feature_decoder(nn.Module):
    def __init__(self):
        ...
        self.upconv3 = nn.Sequential(nn.Upsample(scale_factor=2),
                                     ...
                                     Mish())
        self.iconv2 = nn.Sequential(conv_no_bn(128, 64, 3, 1, 1, 1),
                                    Mish())
        ...
        # self.gw4 = nn.Sequential(conv_no_bn(256, 128, 3, 1, 1, 1),
        #                          Mish(),
        #                          nn.Conv2d(128, 64, kernel_size=1, padding=0, stride=1,
        #                                    bias=False))
        
        # self.gw5 = nn.Sequential(conv_no_bn(512, 256, 3, 1, 1, 1),
        #                          Mish(),
        ...
        # self.inplanes = 512
        # self.layer5 = self._make_layer(BasicBlock, 512, 2, 1, 1, 1)
...
# 1/32--1/16：512//256//320//128，输出 1/16
# 1/16--1/8：256//192//160//128，输出 1/8
# 1/8  --1/4：192//128//128//128，输出 1/8
